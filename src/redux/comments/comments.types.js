...
export const SET_REPLIES_COMMENTS_USER = 'SET_REPLIES_COMMENTS_USER';
export const GET_COMMENTS = 'GET_COMMENTS';
export const GET_COMMENTS_USER = 'GET_COMMENTS_USER';
export const GET_REPLIES_COMMENTS_USER = 'GET_REPLIES_COMMENTS_USER';
...
export const SET_FILTER_REPLY_USER = 'SET_FILTER_REPLY_USER';
export const CLEAR_FILTERS = 'CLEAR_COMMENT_FILTERS';
export const CLEAR_FILTERS_USER = 'CLEAR_FILTERS_USER';
export const CLEAR_FILTERS_REPLY_USER = 'CLEAR_FILTERS_REPLY_USER';
