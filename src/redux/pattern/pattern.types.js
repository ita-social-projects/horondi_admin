...
export const SET_PATTERN_FILTER = 'SET_FILTER';
export const SET_PATTERN_SORT = 'SET_SORT';
export const CLEAR_PATTERN_FILTERS = 'CLEAR_FILTERS';
export const SET_PATTERN_SORT_LABEL = 'SET_PATTERN_SORT_LABEL';
