...
export const SET_PATTERNS_PER_PAGE = 'SET_PATTERNS_PER_PAGE';
export const SET_PATTERNS_CURRENT_PAGE = 'SET_PATTERNS_CURRENT_PAGE';
export const SET_PATTERNS_PAGES_COUNT = 'SET_PATTERNS_PAGES_COUNT';
