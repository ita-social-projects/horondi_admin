import {
  ...
  ADD_CONSTRUCTOR_FRONT_POCKET, ADD_CONSTRUCTOR_PATTERN,
  DELETE_CONSTRUCTOR_BASIC,
  DELETE_CONSTRUCTOR_BOTTOM,
  DELETE_CONSTRUCTOR_FRONT_POCKET, DELETE_CONSTRUCTOR_PATTERN, SET_CONSTRUCTOR_ELEMENT_METHOD, SET_CONSTRUCTOR_TABS,
