...
const modelReducer = (state = initialState, action = {}) => {
  ...
  case REMOVE_CONSTRUCTOR_BASIC_FROM_STORE:
    ...
    deletedModelConstructorBasic.constructorBasic = deletedModelConstructorBasic.constructorBasic.filter(
  ...
  case EDIT_CONSTRUCTOR_BASIC_IN_STORE:
    ...
    const editableConstructorBasicIndex = editableModelConstructorBasic.constructorBasic.findIndex(
  ...
  case REMOVE_CONSTRUCTOR_BOTTOM_FROM_STORE:
    ...
    deletedModelConstructorBottom.constructorBottom = deletedModelConstructorBottom.constructorBottom.filter(
      (basic) => basic._id !== action.payload
    );
  ...
  case EDIT_CONSTRUCTOR_BOTTOM_IN_STORE:
    ...
    const editableConstructorBottomIndex = editableModelConstructorBottom.constructorBottom.findIndex(
  ...
  case REMOVE_CONSTRUCTOR_POCKET_FROM_STORE:
    ...
    deletedModelConstructorPocket.constructorFrontPocket = deletedModelConstructorPocket.constructorFrontPocket.filter(
      (basic) => basic._id !== action.payload
    );
  ...
  case EDIT_CONSTRUCTOR_POCKET_IN_STORE:
    ...
    const editableConstructorPocketIndex = editableModelConstructorPocket.constructorFrontPocket.findIndex(
  ...
  case REMOVE_CONSTRUCTOR_PATTERN_FROM_STORE:
    ...
    deletedModelConstructorPattern.constructorPattern = deletedModelConstructorPattern.constructorPattern.filter(
