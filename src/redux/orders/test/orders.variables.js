// export const operationsAllOrders = {
//   limit: 5,
//   skip: 0,
//   filter: {
...
import { GET_ORDER_LIST, SET_ORDER_LIST } from '../orders.types';
...
export const expectedResultActionsGetOrderList = {
  type: GET_ORDER_LIST,
  payload: {
...
export const expectedResultActionsSetOrderList = {
  type: SET_ORDER_LIST,
  payload: {
    items: [
      {
