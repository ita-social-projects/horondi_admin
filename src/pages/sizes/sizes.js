...
import useSizeFilters from "../../hooks/filters/use-size-filter";
...
const Sizes = () => {
    ...
    const {filterByMultipleOptions, searchOptions, clearOptions} = useSizeFilters();
    const {sizesList, loading, itemsCount, filters, rowsPerPage, currentPage} = useSelector(
