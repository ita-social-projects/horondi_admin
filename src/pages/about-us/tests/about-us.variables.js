...
const { code } = config.labels.aboutUs;
...
export const updateSectionTitleVariables = {
  id: '5fa034039a59a906f0610e37',
  businessText: {
    code: 'about-us',
    title: [
      {
        lang: 'ua',
        value: 'Рюкзаки як терапія'
      },
      {
        lang: 'en',
        value: 'Backpacks as therapy'
      }
    ],
    sections: [
      {
...
export const deleteFilesFromSectionVariables = {
  fileNames: [
    'large_vgu43j8l2z679al_Rectangle 779.png',
    'medium_vgu43j8l2z679al_Rectangle 779.png',
    'small_vgu43j8l2z679al_Rectangle 779.png',
    'thumbnail_vgu43j8l2z679al_Rectangle 779.png'
  ]
};
...
export const aboutUsPageDataMock = [
  {
    ...
    result: {
      data: {
        getBusinessTextByCodeWithPopulatedTranslationsKey: businessPage
      }
    }
  }
];
