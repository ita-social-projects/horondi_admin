  ...
  primaryImage
    ...
    const handleAdditionalImagesLoad = (e) => {
        ...
        if (files && files[0]) {
            ...
            const newImages = Array.from(files).filter(({ name }) =>
                !imagesNames.includes(name) && name !== primaryImage.name
            )
    ...
    return (
        <div className={styles.container}>
            ...
            <StepperButtons activeStep={activeStep} handleBack={handleBack} handleNext={handleImagesLoad}/>
        </div>
    );
};
