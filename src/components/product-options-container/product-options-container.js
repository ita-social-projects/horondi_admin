...
const ProductOptionsContainer = ({
   ...
   additions
    ...
    const optionsToMap = useMemo(() => [sizesOptions, bottomMaterialsOptions], [sizesOptions, bottomMaterialsOptions]) ;
    const cardLabels = useMemo(() => [productSizeCardsLabels, productMaterialsLabels], []) ;
    const cardOptions = useMemo(() => [sizes, formattedMaterials], [sizes, formattedMaterials]);
